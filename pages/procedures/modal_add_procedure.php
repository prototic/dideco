		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<i class='glyphicon glyphicon-edit'></i> Nuevo Producto
				</h4>
			</div>
			<div class="modal-body">
				<div id="resultados_modal_agregar"></div>
				<form class="form-horizontal" method="post" id="add_product" name="add_product">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="ht_codigo" name="ht_codigo" 
								placeholder="Código" maxlength="100" required>
						</div>
					</div>
					<div class="form-group">
