...
<div class="wrapper">
	<?php 
		...
		include_once("modal_add_category.php");
		include_once("modal_edit_category.php");
		include_once("modal_delete_category.php");
	?>
	...
	<div class="content-wrapper">
    	...
    	<section class="content-header">
      		...
      		<ol class="breadcrumb">
        		...
        		<li>Categorias</li>
        		<li class="active">Ver Categorias</li>
      		</ol>
    	</section>
    							...
    							if(canCreateCategories()) {?>
    								<div class="btn-group pull-right">
										<button id="exportButton" name="exportButton" class="btn btn-success pull-right" 
											...
											<span class="fa fa-plus-circle"></span> Agregar Categoria
										</button>
									</div>
							<?php
								} ?>
...
<script>
	...
	$('#addCategory').on('show.bs.modal', function (event) {
		...
		var nombre_usuario = button.data('usuario');
